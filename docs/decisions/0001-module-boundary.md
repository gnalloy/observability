# ADR-001: Keep observability as an Independent Gnalloy Module
...
## Decision
`observability` is published as `gnalloy.org/observability` and owns this responsibility: Vendor-neutral Gnalloy observability contracts, low-overhead recorders, and Prometheus text export.

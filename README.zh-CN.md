...
- 导入路径：`gnalloy.org/observability`
- 仓库：`github.com/gnalloy/observability`
- 默认分支：`dev`
- 预览安装：`go get gnalloy.org/observability@dev`
- 许可证：Apache-2.0
...
本仓库负责：厂商无关的 Gnalloy observability 契约、低开销 recorder 与 Prometheus text export。

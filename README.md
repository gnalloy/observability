...
- Import path: `gnalloy.org/observability`
- Repository: `github.com/gnalloy/observability`
- Default branch: `dev`
- Preview install: `go get gnalloy.org/observability@dev`
- License: Apache-2.0

## Install
```bash
go get gnalloy.org/observability@dev
go doc gnalloy.org/observability
...
This repository owns: Vendor-neutral Gnalloy observability contracts, low-overhead recorders, and Prometheus text export.
